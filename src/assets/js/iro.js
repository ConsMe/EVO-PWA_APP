...
(function (global, factory) {
  ...
  function IroHandle(props) {
      ...
      return (h("svg", { className: ("IroHandle IroHandle--" + (props.index) + " " + (props.isActive ? 'IroHandle--isActive' : '')), x: props.x, y: props.y, style: {
          ...
          !url && (h("circle", { r: radius, fill: "none", "stroke-width": 2, class: 'stroke-current text-white dark:text-4158' })),
          !url && (h("circle", { r: radius - 1, fill: props.fill, "stroke-width": 1, class: 'stroke-current text-white dark:text-4158' }))));
  }
  ...
  function IroSlider(props) {
      ...
      return (h(IroComponentWrapper, Object.assign({}, props, { onInput: handleInput }), function (uid, rootProps, rootStyles) { return null;  }));
